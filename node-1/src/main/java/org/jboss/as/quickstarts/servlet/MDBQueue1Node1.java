...
/**
 * <p>
 * A simple servlet 3 as client that is capable of sending messages to a queue or counting messages in that queue.
 * </p>
 */
@WebServlet("/MDBQueue1Node1")
public class MDBQueue1Node1 extends HttpServlet {
    ...
    @Resource(lookup = "java:/queue/MDBQueue1Node1")
    private Queue queue;
